...
select
    ...
    {{ dbt.safe_cast("Order_Customer_Id", api.Column.translate_type("string")) }} as order_customer_id,
    ...
    {{ dbt.safe_cast("Order_Item_Profit_Ratio", api.Column.translate_type("string")) }} as order_item_profit_ratio,
    {{ dbt.safe_cast("Order_Item_Quantity", api.Column.translate_type("string")) }} as order_item_quantity,
    {{ dbt.safe_cast("Sales_per_customer", api.Column.translate_type("string")) }} as sales_per_customer,
    {{ dbt.safe_cast("Sales", api.Column.translate_type("string")) }} as sales,
    {{ dbt.safe_cast("Order_Item_Total", api.Column.translate_type("string")) }} as order_item_total,
    {{ dbt.safe_cast("Order_Profit_Per_Order", api.Column.translate_type("string")) }} as order_profit_per_order,
