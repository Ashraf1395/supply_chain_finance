...
select
    ...
    {{ dbt.safe_cast("Days_for_shipping_real", api.Column.translate_type("string")) }} as days_for_shipping_real,
    {{ dbt.safe_cast("Days_for_shipping_scheduled", api.Column.translate_type("string")) }} as days_for_shipping_scheduled,
