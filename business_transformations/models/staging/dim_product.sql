...
select
    -- identifiers
    {{ dbt.safe_cast("Product_Card_Id", api.Column.translate_type("string")) }} as product_card_id,
    {{ dbt.safe_cast("Product_Category_Id", api.Column.translate_type("string")) }} as product_category_id,
    ...
    {{ dbt.safe_cast("Product_Price", api.Column.translate_type("string")) }} as product_price,
